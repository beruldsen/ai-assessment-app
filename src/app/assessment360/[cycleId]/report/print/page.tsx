  ...
  return (
    <main className="page report-print-page">
      <section className="card surface-hero print-hide" style={{ marginBottom: 12, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        <p className="meta" style={{ margin: 0 }}>Dedicated print/PDF view.</p>
        <div style={{ display: "flex", gap: 8 }}>
          <Link href={`/assessment360/${cycleId}/report`} className="button ghost" style={{ textDecoration: "none" }}>Back to web report</Link>
      ...
      {!isReportReady ? (
        <section className="card">
          ...
          <p className="meta">{status || "Waiting for submissions."}</p>
        </section>
      ) : null}
        ...
        <div className="report-print-safe">
          <section className="report-sheet">
            <div className="report-sheet-header">
              <div>
                ...
                <div className="report-sheet-meta">{reportDate}</div>
              </div>
            ...
            <div className="report-sheet-section">
              ...
              <div className="print-radar-safe-grid">
                ...
                <div className="print-legend-list">
                  {summary.rows.map((r) => (
                    <div key={`legend-${r.dimension}`} className="print-legend-item">
          ...
          <section className="report-sheet">
            ...
            <div className="report-sheet-section">
              ...
              {summary.developmentPriorities.map((r, idx) => (
                <div key={`priority-${r.dimension}`} className="print-text-block">
          ...
          <section className="report-sheet">
            <div className="report-sheet-section">
              ...
              {summary.rows.map((r) => (
                <div key={`comments-${r.dimension}`} className="print-text-block">
                  <strong>{normalizeDisplayText(r.dimension)}</strong>
                  <div className="meta">Self: {formatScore(r.selfAvg)} · Manager: {formatScore(r.managerAvg)} · Gap: {formatGap(r.gap)}</div>
